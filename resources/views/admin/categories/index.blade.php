...
<x-settings heading="Manage Category">
<div class="flex flex-col"> 
 <div class="-my-2 overflow-x-auto sm:mx-6 lg:mx-8">
    ...
    <tr>
        <th scope="col" class="px-6 py-3 text-left font-medium text-gray-600 uppercase tracking-wider">Category name</th>
       ...
       <form method="POST" action="{{ route('admin.categories.destroy', $category->name) }}">
    @csrf
    @method('DELETE')
